...
class GoodsCategory(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = '商品类别'
        verbose_name_plural = verbose_name   # 去除复数的S
...
class GoodsSPU(BaseModel):
    ...
    desc = HTMLField(default='',blank=True ,verbose_name='商品描述')
...
class GoodsSKU(BaseModel):
    ...
    sales = models.IntegerField(default=0,verbose_name='销售')
...
class IndexCategoryGoods(BaseModel):
    ...
    display_type = models.SmallIntegerField(choices=DISPLAY_TYPE_CHOICE,
                                            verbose_name='展示类型')
    index = models.SmallIntegerField(default=0,verbose_name='顺序')
